...
def calculate_average_prices(price_ranges):
    """计算平均价格列表"""
    average_prices = []
...
def save_to_excel(average_prices, output_path='average_prices.xlsx'):
    """保存到Excel文件"""
    df = pd.DataFrame({
...
def main():
    ...
    print("计算平均售价...")
    average_prices = calculate_average_prices(price_ranges)
    
    print(f"共处理 {len(average_prices)} 个作物的价格")
