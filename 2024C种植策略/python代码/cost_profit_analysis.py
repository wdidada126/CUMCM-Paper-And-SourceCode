...
def plot_cost_profit(df):
    ...
    print("图表已保存为: cost_profit_analysis.png")
    plt.close()

def save_results(df, output_path='cost_profit_results.xlsx'):
    """保存结果"""
